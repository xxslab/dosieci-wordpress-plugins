<?php
/**
 * Plugin Name: DoSieci Translator Pro
 ...
 * Requires PHP: 8.1
 * Author: DoSieci
 * Text Domain: dosieci-translator-pro
...
define( 'DOSIECI_TRANSLATOR_PRO_VERSION', '0.0.1-dev' );
define( 'DOSIECI_TRANSLATOR_PRO_FILE', __FILE__ );
define( 'DOSIECI_TRANSLATOR_PRO_PATH', plugin_dir_path( __FILE__ ) );
define( 'DOSIECI_TRANSLATOR_PRO_URL', plugin_dir_url( __FILE__ ) );
define( 'DOSIECI_TRANSLATOR_PRO_CAPABILITY', 'manage_dosieci_translator' );

// Faza 0: brak autoloadera Composer i klas domenowych — celowy szkielet, patrz ARCHITECTURE.md.
// Faza 1+: require_once DOSIECI_TRANSLATOR_PRO_PATH . 'vendor/autoload.php'; oraz bootstrap klas Domain/Adapter/UI.
